...
class PayPalService {
  ...
  static bool get sandbox => (dotenv.env['PAYPAL_MODE'] ?? 'sandbox') == 'sandbox';
  static String get returnUrl => dotenv.env['PAYPAL_CALLBACK_URL'] ?? 'https://samplesite.com/return';
  ...
  static Future<bool> makePayment({
    ...
    try {
      debugPrint('[PayPalService] Starting payment. clientId: $clientId, sandbox: $sandbox, returnUrl: $returnUrl');
        ...
        MaterialPageRoute(
          builder: (BuildContext context) => UsePaypal(
            ...
            onSuccess: (Map params) {
              debugPrint('[PayPalService] Payment success: ' + params.toString());
              onResult(true);
